const AboutMe = () => {
  return (
    <div className="w-full centered-col relative">
      ...
      <div className="flex items-center justify-between w-full max-w-[59rem] mb-16">
        <div>
          <p className="w-[23rem]">
        ...
        <div>
          <img
            ...
            className="rounded-2xl w-[22rem]"
          />
        </div>
      </div>
      <div className="centered-row w-full max-w-[59rem]">
        <p className="text-lg">
          <span className="block mb-4">
            ...
            you name it. From comedy videos to documentaries and eye-catching
            ads, I've brought plenty of ideas to life.
          </span>
          <span className="block mb-4">
            ...
            for years, that question from a UI designer friend sparked a
            curiosity in me. It was the push I needed to start a new chapter in
            my creative journey—into the world of <strong>UI/UX design</strong>.
          </span>
          <span className="block mb-4">
            ...
            at marketing and social media strategy &ndash; because, why not,
            right?
          </span>
