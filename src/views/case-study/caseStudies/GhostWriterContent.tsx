    ...
    >
      ...
      >
        <p>
          ...
          key questions. This helped me grasp their concerns and set clear goals
          for the new design.
        </p>
      ...
      >
        ...
        <ul className="space-y-6">
          ...
          <li className="space-y-6">
            ...
            <img src={getCloudUrl("gw/frame-size-issues.png")} loading="lazy" />
          </li>
        </ul>
      </GWCaseStudySection>
      ...
      >
        <p>
          ...
          to pick their favorite design and explain their choices. Here are some
          key responses that shaped our final design:
        </p>
        ...
        <p>
          ...
          were on the right track. Their feedback was essential in finalizing a
          design that looked great and functioned well, leading to a noticeable
          boost in our Reels' performance.
        </p>
        <h3>Final Design</h3>
